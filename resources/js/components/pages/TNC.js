    ...
    return (
        ...
        <div class="container" id="terms-conditions-page">
            <p>
                ...
                to it, still belong to Crossfire Legacy. Legacy Staff is
                committed to ensuring that the app is as useful and efficient as
                possible. For that reason, we reserve the right to make changes
                to the app or to charge for its services, at any time and for
                ...
                for. The Crossfire Legacy app stores and processes personal data that
                ...
                security features and it could mean that the Crossfire Legacy app
                won’t work properly or at all. The app does use third-party
                services that declare their Terms and Conditions. Link to Terms
                and Conditions of third-party service providers used by the app
            </p>
            <p>
            &emsp;&emsp;&emsp;You should be aware that there are certain things
            that Staff Crossfire Legacy will not take responsibility for. Certain
            ...
            network provider, but Staff Crossfire Legacy cannot take responsibility
            ...
            same lines, Staff Crossfire Legacy cannot always take responsibility for
            ...
            to avail the Service, Staff Crossfire Legacy cannot accept
            responsibility. With respect to Staff Crossfire Legacy’s responsibility
            ...
            Staff Crossfire Legacy accepts no liability for any loss, direct or
            indirect, you experience as a result of relying wholly on this
            functionality of the app. At some point, we may wish to update the
            app. The app is currently available on Android – the requirements
            for the system(and for any additional systems we decide to extend
            the availability of the app to) may change, and you’ll need to
            download the updates if you want to keep using the app. Staff
            Crossfire Legacy does not promise that it will always update the app so
            that it is relevant to you and/or works with the Android version
            ...
            <h1 id="changes-to-this-terms-and-conditions">
                Changes to This Terms and Conditions
            </h1>
            <p>
                &emsp;&emsp;&emsp;I may update our Terms and Conditions from
                time to time. Thus, you are advised to review this page
                periodically for any changes. I will notify you of any changes
                by posting the new Terms and Conditions on this page. These
                terms and conditions are effective as of 2024-02-26
            </p>
        </div>
    </>    
    );
